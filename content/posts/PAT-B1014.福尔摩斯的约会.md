...
如果用心学习的同学可能会发现，PAT-B 系列更多侧重于“看图写话”的题目，所牵涉到的算法和数学思想并不太多，重点是如何处理文字信息转换成代码，这也是成为一个优秀程序员必不可少的一步，要不然产品经理提需求，总不能说这个需求做不了吧。哈哈哈哈哈~~ 本期 **PAT-B1014.福尔摩斯的约会** 就讲到这里。OK，这一期就到这里，让我们期待下一期的内容吧！
